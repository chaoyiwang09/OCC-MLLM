...
OUTPUT_DIR='/root/autodl-tmp/workspace/InternVL/internvl_chat/shell/internvl2.0/2nd_finetune/4b-10140/outputdir-8b-Q1-Q6'
...
torchrun \
  ...
  --model_name_or_path "/root/autodl-tmp/workspace/InternVL/internvl_chat/shell/internvl2.0/2nd_finetune/4b-10140/outputdir-4b-Q1" \
  --conv_style "phi3-chat" \
  --output_dir ${OUTPUT_DIR} \
  --meta_path "/root/autodl-tmp/workspace/InternVL/internvl_chat/shell/data/chaoyi_finetune_Q1_Q6_10140.json" \
